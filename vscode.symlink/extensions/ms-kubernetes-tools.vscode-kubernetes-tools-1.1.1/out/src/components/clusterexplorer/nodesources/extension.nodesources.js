...
class NodeSource {
    ...
    if(condition) {
        return new conditional_1.ConditionalNodeSource(this, condition);
    }
}
    ...
    const listerObj = lister ? {
        list(_kubectl, kind) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return infos.map((i) => node_resource_1.ResourceNode.createForCustom(kind, i.name, i.customData, crcs));
            });
        }
    } : undefined;
