...
class DefaultCreateNewSamAppWizardContext {
    constructor(extContext) {
        ...
        this.helpButton = buttons_1.createHelpButton(this.extContext, localize('AWS.command.help', 'View Documentation'));
    }
...
class BrowseFolderQuickPickItem {
    constructor(context) {
        this.context = context;
        this.label = localize('AWS.samcli.initWizard.name.browse.label', 'Choose a different folder...');
