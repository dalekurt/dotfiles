...
function invokeLambda(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const fn = yield utils_1.selectLambdaNode(params.awsContext, params.element);
            const view = vscode.window.createWebviewPanel('html', `Invoked ${fn.configuration.FunctionName}`, vscode.ViewColumn.One, {
