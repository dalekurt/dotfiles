...
class DefaultCloudFormationNode extends awsTreeErrorHandlerNode_1.AWSTreeErrorHandlerNode {
    ...
    updateChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            collectionUtils_1.updateInPlace(this.stackNodes, stacks.keys(), key => this.stackNodes.get(key).update(stacks.get(key)), key => new DefaultCloudFormationStackNode(this, stacks.get(key), relativeExtensionPath => this.getExtensionAbsolutePath(relativeExtensionPath)));
        });
    }
}
...
class DefaultCloudFormationStackNode extends awsTreeErrorHandlerNode_1.AWSTreeErrorHandlerNode {
    constructor(parent, stackSummary, getExtensionAbsolutePath) {
    ...
    updateChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            collectionUtils_1.updateInPlace(this.functionNodes, collectionUtils_1.intersection(resources, functions.keys()), key => this.functionNodes.get(key).update(functions.get(key)), key => new DefaultCloudFormationFunctionNode(this, functions.get(key), relativeExtensionPath => this.getExtensionAbsolutePath(relativeExtensionPath)));
        });
    }
