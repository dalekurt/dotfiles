...
class LocalLambdaRunner {
    ...
    outputChannel, processInvoker, localInvokeCommand, debugConfig, codeRootDirectoryPath, telemetryService, onDidSamBuild, channelLogger = vsCodeUtils_1.getChannelLogger(outputChannel)) {
        ...
        this.onDidSamBuild = onDidSamBuild;
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const samBuildTemplate = yield this.executeSamBuild(this.codeRootDirectoryPath, inputTemplate);
    ...
    generateInputTemplate(rootCodeFolder) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const handlerFileRelativePath = path.relative(rootCodeFolder, path.dirname(this.localInvokeParams.document.uri.fsPath));
    ...
    executeSamBuild(rootCodeFolder, inputTemplatePath) {
        return __awaiter(this, void 0, void 0, function* () {
            this.channelLogger.info('AWS.output.building.sam.application', 'Building SAM Application...');
            const samBuildOutputFolder = path.join(yield this.getBaseBuildFolder(), 'output');
            const samCliArgs = {
    ...
    invokeLambdaFunction(samTemplatePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield filesystem_1.writeFile(environmentVariablePath, JSON.stringify(this.getEnvironmentVariables(config)));
