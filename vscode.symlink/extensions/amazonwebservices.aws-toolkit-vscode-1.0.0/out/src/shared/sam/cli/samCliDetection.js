...
function notifyUserSamCliNotDetected(samCliConfig) {
    ...
    vscode.window.showErrorMessage(localize('AWS.samcli.error.notFound', 
    // tslint:disable-next-line:max-line-length
    'Unable to find the SAM CLI, which is required to create new Serverless Applications and debug them locally. If you have already installed the SAM CLI, update your User Settings by locating it.'), learnMore, browseToSamCli).then((userResponse) => __awaiter(this, void 0, void 0, function* () {
