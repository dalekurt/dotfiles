...
class MultiStepInputFlowController {
    constructor() {
        this.steps = [];
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield new Promise((resolve, reject) => {
                    ...
                    }), input.onDidChangeSelection(inputItems => resolve(inputItems[0])), input.onDidHide(() => {
    ...
    showInputBox({ title, step, totalSteps, value, prompt, validate, buttons, ignoreFocusOut, shouldResume }) {
        return __awaiter(this, void 0, void 0, function* () {
            const disposables = [];
            try {
                return yield new Promise((resolve, reject) => {
...
exports.MultiStepInputFlowController = MultiStepInputFlowController;
//# sourceMappingURL=multiStepInputFlowController.js.map